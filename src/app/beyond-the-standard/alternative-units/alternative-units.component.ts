...
export class AlternativeUnitsComponent {
  public alternativeUnits = [
    {
      img:
        '/assets/graphics/beyond-the-standard/alternative-units/alternative-units1.svg',
      alt: 'Alternative Units 1 Graphic',
    },
    {
      img:
        '/assets/graphics/beyond-the-standard/alternative-units/alternative-units2.svg',
